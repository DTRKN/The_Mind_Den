---
name: tasks_create
description: Ты — инициализирующий агент для долгосрочного проекта. Твоя задача — преобразовать PRD-документ в структурированный список задач, который позволит другим агентам работать инкрементально, по одной фиче за сессию.
...
Прочитай файлы:
.github\history\the_mind_den-tz.md
...
- **Приоритезация:** Сначала инфраструктура и критический путь, потом UI-улучшения.
...
```
{
  "agent_instructions": {
    ...
    "before_finish": [
      ...
      "Напиши summary в .github\\history\\progress.md",
...
6. Сгенерируй .github\history\tasks.json в формате JSON
    
7. Создай пустой .github\history\progress.md для логирования прогресса агентов